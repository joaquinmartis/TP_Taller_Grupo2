...
public class TestTicket31 {
	...
	public void setUp() throws Exception {
		...
		this.ticket = new Ticket(util.Constantes.INDISTINTO, 2001, util.Constantes.JORNADA_EXTENDIDA, util.Constantes.MANAGMENT, util.Constantes.EXP_MUCHA, util.Constantes.TERCIARIOS);
		this.otro = new Ticket(util.Constantes.HOME_OFFICE, 999, util.Constantes.JORNADA_MEDIA, util.Constantes.JUNIOR, util.Constantes.EXP_NADA, util.Constantes.PRIMARIOS);
	}
	...
	public void testGetComparacionTotal() {
		Assert.assertEquals("Error en getComparacionTotal() 31", -4, this.ticket.getComparacionTotal(this.otro), 0.0001);
	}
}
